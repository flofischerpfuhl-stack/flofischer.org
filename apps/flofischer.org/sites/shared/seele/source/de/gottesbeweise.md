...
<img src="/shared/seele/article-images/stephen-meyer.jpg">
...
```mermaid
graph TD
    subgraph Synoptische Evangelien
        A[Evangelium nach Markus]
        B[Evangelium nach Matthäus]
        C[Evangelium nach Lukas]
    end
    ...
    classDef gospel fill:#f96,stroke:#333,stroke-width:2px;
    class A,B,C,D gospel;
