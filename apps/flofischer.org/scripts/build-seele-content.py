...
PORTRAITS = {
    "William Lane Craig": ("william-lane-craig.webp", "William Lane Craig"),
    "Robert C. Koons": ("robert-koons.webp", "Robert C. Koons"),
    "Joe Schmid": ("joe-schmid.webp", "Joe Schmid"),
    "Aristotle": ("aristotle.webp", "Aristotle"),
    "Ed Feser": ("edward-feser.webp", "Edward Feser"),
    "Thomas Aquinas": ("thomas-aquinas.webp", "St. Thomas Aquinas"),
    "Gottfried Wilhelm Leibniz": ("leibniz.webp", "Gottfried Wilhelm Leibniz"),
    "Trent Horn": ("trent-horn.webp", "Trent Horn"),
    "Plato": ("plato.webp", "Plato"),
    "William Paley": ("william-paley.webp", "William Paley"),
    "Richard Dawkins": ("richard-dawkins.webp", "Richard Dawkins"),
    "Anselm of Canterbury": ("anselm.webp", "St. Anselm of Canterbury"),
    "Alvin Plantinga": ("alvin-plantinga.webp", "Alvin Plantinga"),
    "Kurt Gödel with Albert Einstein": ("godel-einstein.webp", "Kurt Gödel with Albert Einstein"),
    "Alexander Pruss": ("alexander-pruss.webp", "Alexander Pruss"),
