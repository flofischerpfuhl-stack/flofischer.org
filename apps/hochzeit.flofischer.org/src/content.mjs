...
export const CARDS = [
  ...
  {
    id: "aktion-2", cat: "Aktion", stars: 2, kind: "physical", mode: "stopwatch", title: "Hemd-Staffel",
    text: "Zehn Personen pro Team ziehen dasselbe Hemd nacheinander vollständig an und wieder aus.",
    setup: ["Je Team zehn Personen in fester Reihenfolge und ein passend großes, vollständig aufgeknöpftes Hemd", "Je Team genau eine feste Hilfsperson bestimmen; sie darf während der gesamten Staffel helfen", "Beide Teams starten gleichzeitig; zwei vergleichbare Hemden und gleicher Startzustand"],
    ...
    decision: "Wer zuerst alle zehn Personen vollständig an- und wieder ausgezogen hat, gewinnt. Die Moderation klickt das Siegerteam. Bei gleichzeitigem Ziel: ein weiterer Durchgang pro Team.",
  },
  {
  ...
  {
    id: "party-2", cat: "Party", stars: 2, kind: "physical", mode: "team-rounds", durationMs: 60000, title: "Pantomime",
    text: "Jedes Team hat 60 Sekunden: einfache Begriffe darstellen und möglichst viele erraten.",
    setup: ["Die Website hält je Team 30 kurze Begriffe bereit; keine Papierkarten nötig", "Team Kathi spielt zuerst, danach Team Anton; nur die darstellende Person sieht den Begriff bei der Moderation", "Eine darstellende Person je Team, die anderen im eigenen Team raten"],
    ...
    termSets: {
      rosa: ["Zähne putzen", "Elefant", "Schwimmen", "Fotograf", "Banane", "Staubsaugen", "Roboter", "Gitarre", "Schlafen", "Kellner", "Regenschirm", "Boxen", "Pinguin", "Kochen", "Telefon", "Ballett", "Känguru", "Angeln", "Friseur", "Flugzeug", "Niesen", "Katze", "Skifahren", "Zauberer", "Schneemann", "Bügeln", "Pirat", "Joggen", "Trompete", "Geschenk"],
      blau: ["Haare kämmen", "Giraffe", "Tauchen", "Maler", "Zitrone", "Fenster putzen", "Zombie", "Klavier", "Aufwachen", "Koch", "Sonnenbrille", "Fechten", "Flamingo", "Backen", "Fernglas", "Disco", "Frosch", "Reiten", "Zahnarzt", "Hubschrauber", "Husten", "Hund", "Surfen", "Clown", "Sandburg", "Fegen", "Cowboy", "Wandern", "Geige", "Luftballon"],
    },
  },
  {
    id: "party-3", cat: "Party", stars: 5, kind: "physical", mode: "cutting", title: "Die größere Hälfte",
    text: "Drei Gegenstände, je zwei Schnitte: Das andere Team rät, welches Stück schwerer ist.",
    setup: ["Drei gut teilbare Gegenstände, Unterlage, geeignetes Schneidewerkzeug und Küchenwaage bereitlegen", "Links und rechts aus Sicht des Publikums eindeutig kennzeichnen und die Teile nicht vertauschen", "In jeder Runde schneidet zuerst Kathi; Anton schneidet danach das größere Stück noch einmal"],
    rules: ["Nach jedem Schnitt rät das andere Team: links, rechts oder gleich schwer. Tipp festhalten, bevor gewogen wird", "Beide Stücke wiegen. Richtiger Tipp: ein Einzelpunkt fürs ratende Team; falscher Tipp: ein Einzelpunkt fürs schneidende Team", "Nach dem zweiten Schnitt beginnt die nächste Runde mit einem neuen Gegenstand; insgesamt sechs Entscheidungen"],
    decision: "Nach drei Runden gewinnt die höhere Zahl an Einzelpunkten die fünf Showpunkte. Bei 3:3 bekommen beide Teams fünf Showpunkte.",
  },
  {
  ...
  {
    id: "party-5", cat: "Party", stars: 3, kind: "physical", mode: "countdown", durationMs: 180000, audienceDecision: true, title: "Klopapier-Brautkleid",
  ...
  { id: "vote-1", cat: "Abstimmung", stars: 1, kind: "vote", guessMode: "percentage", title: "Hund oder Katze?", a: "Hund", b: "Katze", minVotes: 3, durationMs: 30000, text: "Beide Teams schätzen verdeckt den prozentualen Hunde-Anteil; dann stimmen die Gäste ab." },
  { id: "vote-2", cat: "Abstimmung", stars: 2, kind: "vote", guessMode: "percentage", title: "München oder Berlin?", a: "München", b: "Berlin", minVotes: 3, durationMs: 30000, text: "Beide Teams schätzen verdeckt den prozentualen München-Anteil." },
  { id: "vote-3", cat: "Abstimmung", stars: 3, kind: "vote", guessMode: "percentage", title: "Lidl oder Aldi?", a: "Lidl", b: "Aldi", minVotes: 3, durationMs: 30000, text: "Beide Teams schätzen verdeckt den prozentualen Lidl-Anteil." },
  { id: "vote-4", cat: "Abstimmung", stars: 5, kind: "vote", guessMode: "percentage", title: "Geimpft oder ungeimpft?", a: "Geimpft", b: "Ungeimpft", minVotes: 3, durationMs: 30000, text: "Beide Teams schätzen verdeckt den prozentualen Geimpft-Anteil." },
  { id: "vote-5", cat: "Abstimmung", stars: 4, kind: "vote", guessMode: "percentage", title: "Organisiert oder Sponti?", a: "Organisiert", b: "Sponti", minVotes: 3, durationMs: 30000, text: "Beide Teams schätzen verdeckt den prozentualen Anteil der Organisierten." },
];
